...
Pod::Spec.new do |s|
  ...
  #s.author             = { "Jiabao" => "Jiabao.shen@yunzhihui.com" }
  s.author    = "DataVI"
  # s.authors            = { "Jiabao" => "Jiabao.shen@yunzhihui.com" }
  # s.social_media_url   = "http://twitter.com/Jiabao"
  ...
  s.source       = { :git => "https://github.com/JIabao1/DataVI.git", :tag => "v#{s.version}" }
